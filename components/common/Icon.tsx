...
export const IconFilePlus: React.FC<IconProps> = (props) => (
...
export const IconCurrencyRupee: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 8.25H9m6 3H9m3 6.75h3m9-6.75c0 5.25-4.25 9.5-9.5 9.5S3 17.75 3 12.5 7.25 3 12.5 3s9.5 4.25 9.5 9.5Z" />
    </svg>
);
